 ...
 */
class ApnsDeviceHistory extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('appname, deviceuid, devicetoken, devicename, devicemodel, deviceversion, archived', 'required'),
            ...
            array('pid, appname, appversion, deviceuid, devicetoken, devicename, devicemodel, deviceversion, pushbadge, pushalert, pushsound, development, status, archived', 'safe', 'on'=>'search'),
        );
    }
